...
public class PurchaserOrderExportVO {
    ...
    @ExcelProperty(value = "收货地址二", index = 11)
    ...
    @ColumnWidth(15)
    @ExcelProperty(value = "支付状态", index = 14)
    private String paymentStatus;

    @ColumnWidth(15)
    @NumberFormat("#.##")
    @ExcelProperty(value = "手续费", index = 15)
    private BigDecimal serviceCharge;

    @ColumnWidth(15)
    @NumberFormat("#.##")
    @ExcelProperty(value = "订单金额", index = 16)
    ...
    @ColumnWidth(10)
    @NumberFormat("#.###")
    @ExcelProperty(value = "汇率", index = 18)
    private BigDecimal exchangeRate;

    @ColumnWidth(30)
    @ExcelProperty(value = "回填单号", index = 19)
    private String remarkOrderNo;

    @ColumnWidth(20)
    @ExcelProperty(value = "订单备注", index = 20)
    private String remark;

    @ColumnWidth(20)
    @ExcelProperty(value = "取消原因", index = 21)
    private String cancelReason;

    @ColumnWidth(20)
    @ExcelProperty(value = "取消时间", index = 22)
    ...
    @ColumnWidth(20)
    @ExcelProperty(value = "更新时间", index = 27)
    @DateTimeFormat("yyyy-MM-dd HH:mm:ss")
    private Date updatedAt;

    @ColumnWidth(15)
    @ExcelProperty(value = "更新人", index = 28)
    private String updatedBy;

    // 商品明细字段（不会合并）
    @ColumnWidth(30)
    @ExcelProperty(value = "商品名称", index = 29)
    private String productName;

    @ColumnWidth(50)
    @ExcelProperty(value = "商品链接", index = 30)
    private String productLink;

    @ColumnWidth(50)
    @ExcelProperty(value = "商品图片", index = 31)
    private String productImage;

    @ColumnWidth(20)
    @ExcelProperty(value = "SKU", index = 32)
    private String sku;
    ...
    @ColumnWidth(10)
    @ExcelProperty(value = "采购数量", index = 34)
