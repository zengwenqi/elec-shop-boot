...
public class PurchaseTaskController {
    ...
    @PostMapping("/query")
    public Result queryMyPurchaseTask(@RequestBody PurchaserTaskQueryDTO query) {
    ...
    public Result taskStatusChange(@RequestBody TaskStatusChangeDTO dto) {
    ...
    @ApiOperation("采购任务详情")
    @PostMapping("/info")
    public Result taskInfo(@RequestBody PurchaserTaskQueryDTO dto) {
        // 调用服务层获取任务详情
